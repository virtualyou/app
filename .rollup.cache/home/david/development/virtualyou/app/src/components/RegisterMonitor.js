...
const RegisterMonitor = () => {
    ...
    const handleRegister = (formValue) => {
        ...
        setMessage("");
        setSuccessful(false);
        AuthService.registerHelper(username, email, password, parseInt(idOwner), "monitor").then(response => {
