...
RegisterMonitor.tsx - Monitor registration (component)
...
const RegisterMonitor = () => {
    ...
    const handleMonitorRegister = (formValue: { username: string; email: string; fullname: string; password: string; idOwner: string; rsvp: number }) => {
